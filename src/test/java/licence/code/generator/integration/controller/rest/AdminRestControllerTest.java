...
class AdminRestControllerTest {
    ...
    public void showAllUsers_shouldReturnMultipleUsers() throws Exception {
        ...
        //when:
        MvcResult result = mvc.perform(get(ADMIN_INFO_PATH).contentType(MediaType.APPLICATION_JSON)).andReturn();
    ...
    void blockUser_shouldSuccessfullyBlockUserOnly() throws Exception {
        ...
        //when:
        MvcResult result = mvc.perform(post(ADMIN_BLOCK_PATH)
    ...
    void unblockUser_shouldSuccessfullyUnblockUserOnly() throws Exception {
        ...
        //when:
        MvcResult result = mvc.perform(post(ADMIN_UNBLOCK_PATH)
                        .contentType(MediaType.APPLICATION_JSON)
